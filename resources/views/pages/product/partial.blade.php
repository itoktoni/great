	...
	<div class="card-body">
		<div class="row">
			<div class="col-md-6">
				...
				<x-input model="product_name" :label="__('Email Address')" type="text"/>

				<div class="form-group {{ $errors->has('product_name') ? 'has-error' : '' }}">
					<label>{{ __('Name') }}</label>
					{!! Form::text('product_name2', null, ['class' => 'form-control', 'id' => 'product_name',
					'placeholder'
			...
			<div class="col-md-6">
				...
				<div class="form-group {{ $errors->has('file_logo') ? 'has-error' : '' }}">
					...
					<div class="custom-file">
						<input type="file" name="file_picture" class="custom-file-input" id="customFile">
